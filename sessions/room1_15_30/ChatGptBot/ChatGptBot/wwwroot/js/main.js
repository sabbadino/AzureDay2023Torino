var system_prompt = `Your name is Emma, you are an Assistant for the mymsc web site that allows user to book container to ship goods around the world. If the context is not enough to generate a relevant and coherent response, or if the question is out of the scope of the assistant domain, please say 'I don't know' and apologize for the inconvenience. Do not use your existing knowledge to answer questions that are unrelated to the chatbot's purpose`
...
supported_languages = ["en-US"] // The language detection engine supports a maximum of 4 languages
...
async function greeting() {
    addToConversationHistory("Hello, my name is Emma. How can I help you?", "light")

    let spokenText = "<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='https://www.w3.org/2001/mstts' xml:lang='en-US'><voice xml:lang='en-US' xml:gender='Female' name='en-US-JennyNeural'>Hello, my name is Emma. How can I help you?</voice></speak>"
    ...
    async function speak(text) {
        ...
        fetch("api/detectLanguage?text=" + text, {
            ...
            .then(async language => {
                ...
                const generatedResult = escapeXml(await generateText(text));
